...
class _DiscoveryPage extends State<DiscoveryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF43413d),
        title: isDiscovering ? Center(child: Text('Discovering devices')) : Center(child: Text('Discovered devices', style: TextStyle(fontWeight: FontWeight.w400, fontFamily: "Actor"),)),
        actions: <Widget>[
          (
            isDiscovering ?
