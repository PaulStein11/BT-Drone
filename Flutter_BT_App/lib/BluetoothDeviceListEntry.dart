...
class BluetoothDeviceListEntry extends ListTile {
  BluetoothDeviceListEntry({
    ...
    enabled: enabled,
    leading: Icon(Icons.devices, color: Color(0xFFB3B3B3),), // @TODO . !BluetoothClass! class aware icon
    title: Text(device.name ?? "Unknown device", style: TextStyle(color: Color(0xFFB3B3B3)),),
    subtitle: Text(device.address.toString(), style: TextStyle(color: Color(0x89B3B3B3)),),
    trailing: Row(
      ...
      children: <Widget>[
        ...
        device.isConnected ? Icon(Icons.import_export, color: Color(0xFFB3B3B3)) : Container(width: 0, height: 0),
        device.isBonded ? Icon(Icons.link, color: Color(0xFFB3B3B3),) : Container(width: 0, height: 0),
      ]
    ),
  );
}
